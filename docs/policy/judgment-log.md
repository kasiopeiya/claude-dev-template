...
[refined-engineer-judgment-principles.md](refined-engineer-judgment-principles.md) に載せる原則を**実データから抽出する**ための、加工前の素材を貯めるappend-onlyログ。AIが自律的に下した非自明な判断と、人間からの判断矯正を生のまま記録する。これ自体は規範（ポリシー）ではなく、原則を育てるための**観測データ置き場**である。
