...
| 不便                                             | 内容                                                                                                                                                                                                     |
| ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| デプロイ成功未確認のままPRレビューすることになる | cdkデプロイはmainマージ後であるため、PRレビュー時点ではデプロイ失敗する可能性のあるコードをレビューすることになる [001-post-merge-dev-deploy.md](./samples/docs/design/adr/001-post-merge-dev-deploy.md) |
